...
of Emacs as a text editor, and do NOT add support to other languages or etc.
...
I mean, it's basically a tool to interface with the D&D LaTeX class. Not that
nerdy, is it?
...
As languages that are part of =cc-mode= are known to using a lot of doxygen,
here's a package that highlights it!
...
(use-package elisp-mode
  ...
  ((after-save-hook . recompile-elc-on-save)
   (emacs-lisp-mode-hook . (lambda () (run-hooks 'lisp-mode-hooks)))
