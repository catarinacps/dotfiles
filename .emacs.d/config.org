...
(use-package undo-tree
  ...
  (defun undo-tree-diff-hide-mode-line (&rest args)
    "`add-advice' requires the `args' of the original function."
    (hide-mode-line-mode))
  ...
  ((after-init-hook . global-undo-tree-mode)
   ...
   (diff-mode-hook . hide-mode-line-mode))
  :init
...
(use-package olivetti
  ...
  (olivetti-mode)
  :hook
  (olivetti-mode-on-hook . hide-mode-line-mode)
  :custom
  (olivetti-body-width (+ 3 fill-column))
  :general
  (:states '(normal visual)
   :prefix hcps/leader-key
   "m o" 'olivetti-mode))
