...
best features of other famous editor, such as Visual Studio Code. By using
...
#+begin_src emacs-lisp :tangle yes
(setq-default lsp-julia-default-environment "~/.julia/environments/v1.2")
...
(use-package julia-mode
  ...
  :mode "\\.jl\\'"
  :hook
  (ess-julia-mode . julia-repl-mode)
  :init
  (setq inferior-julia-program-name "/usr/bin/julia"))
#+end_src
