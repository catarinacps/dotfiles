...
(use-package org
  ...
  ((org-mode . org-indent-mode)
   ...
   (org-export-latex-after-initial-vars . org-auto-tex-cmd))
  :custom
  ...
  (org-babel-do-load-languages
   ...
   '((shell . t)
     ...
     (jupyter . t)
     (lilypond . t)))
  (add-to-list 'org-src-lang-modes '("jupyter" . julia))
...
#+RESULTS:
: 837be1984c1d3c424ff3467dc038c07c
