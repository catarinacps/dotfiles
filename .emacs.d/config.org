...
- [[#the-editor][The editor]]
  - [[#definitions-and-preferences][Definitions and preferences]]
    ...
    - [[#paths-and-defvar][Paths and =defvar=]]
...
#+begin_src emacs-lisp :tangle yes
(defvar config-file-name (expand-file-name "config.org" user-emacs-directory)
  "The path to the configuration ")

(defun hcps/byte-compile-org-config ()
  "To add as a hook when saving the config file."
  (if (y-or-n-p "Recompile config?")
      (byte-compile-file (car (org-babel-tangle-file config-file-name)))))
...
(defvar root-dir (expand-file-name user-emacs-directory) "The root dir of Emacs.")
...
(use-package general
  :demand
  :commands (general-def general-define-key general-unbind)
  :preface
...
(use-package projectile
  ...
  (:states '(normal visual)
   :prefix hcps/leader-key
   "p" '(:wk "projectile" :keymap projectile-command-map :package projectile))
  :config
