...
(use-package evil
  ...
  (defun hcps/shift-right-region ()
    ...
    (evil-normal-state)
    (evil-visual-restore))
  (defun hcps/indent-when-paste (old-fun &rest args)
    "Indents the pasted region."
    (indent-region (point) (+ (point) (length (apply old-fun args)))))
  :init
  (defconst hcps/leader-key "SPC")
  (advice-add 'evil-paste-before :around #'hcps/indent-when-paste)
  (advice-add 'evil-paste-after :around #'hcps/indent-when-paste)
  :general
...
(use-package org
  ...
  :custom ;; this is getting kinda big
