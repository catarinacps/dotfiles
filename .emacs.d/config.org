...
Defaults that are better other way.
...
(setq-default
 ...
 indent-tabs-mode nil                            ; Never use tabs! TODO makefile uses tabs!
 tab-width 4                                     ; Set width for tabs
 line-spacing nil                                ; Set no extra line spacing
 uniquify-buffer-name-style 'forward             ; Uniquify buffer names
 display-line-numbers-type 'relative             ; Set relative line numbering
 window-combination-resize t                     ; Resize windows proportionally
 scroll-step 1                                   ; Vim-like scrolling
 scroll-conservatively 10000
 require-final-newline t                         ; Add a newline at the end
...
(set-face-attribute 'default nil :family "Hack") ; Sets the font to Hack
(global-display-line-numbers-mode)               ; Sets the number line globally
(line-number-mode t)                             ; Show the line number on modebar
(column-number-mode t)                           ; Show column on modebar
(size-indication-mode t)                         ; Show filesize on modebar
(blinking-cursor-mode -1)                        ; Disables the blinking cursor
...
Here I define the theme that I use.
