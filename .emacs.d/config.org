...
(use-package sh-script
  ...
  :preface
  (defvar more-sh-builtin-keywords
    '("addbib" "apropos" "ar" "at" "awk" "banner" "basename" "batch" "biff" "chroot"
      "cal" "calendar" "cancel" "cat" "cb" "cc" "cd" "checknr" "checkeq" "chgrp"
      "chmod" "clear" "cmp" "colcrt" "comm" "compress" "cp" "cpio" "cpp" "csh" "dd"
      "ctags" "cut" "date" "dbx" "deroff" "df" "diff" "du" "e" "echo" "ed" "red"
      "edit" "eqn" "ex" "expand" "expr" "false" "file" "find" "finger" "fmt" "env"
      "fold" "ftp" "gprof" "grep" "groups" "head" "hostname" "indent" "install" "dirname"
      "join" "kill" "last" "ld" "leave" "lex" "lint" "ln" "login" "look" "pgrep" "git"
      "lookbib" "lorder" "lp" "lpq" "lpr" "lprm" "ls" "mail" "make" "man" "printf"
      "mesg" "mkdir" "mkstr" "more" "mv" "nice" "nm" "neqn" "nroff" "od" "page" "tac"
      "passwd" "paste" "pr" "prof" "ps" "pwd" "ranlib" "rcp" "rev" "rlogin" "rm" "unlink"
      "rmdir" "roffbib" "rsh" "rup" "ruptime" "rusers" "rwall" "rwho" "sccs" "seq"
      "script" "sed" "sh" "size" "sleep" "sort" "sortbib" "spell" "split" "pkill"
      "strings" "strip" "stty" "su" "sudo" "tabs" "tail" "talk" "tar" "tbl" "less"
      "tee" "telnet" "test" "tftp" "time" "touch" "troff" "true" "tsort" "tty" "mkfifo"
      "ul" "uncompress" "uniq" "units" "uptime" "users" "uucp" "unexpand" "chown"
      "vacation" "vi" "vedit" "view" "w" "wait" "wall" "wc" "whatis" "whereis" "uname"
      "which" "who" "whoami" "write" "xargs" "xstr" "yacc" "yes" "zcat" "timeout")
    "A list of common shell commands and keywords to be fontified especially in `sh-mode'.")
  ...
  (font-lock-add-keywords
   'sh-mode `((sh--match-variables-in-quotes
              ...
              (,(regexp-opt more-sh-builtin-keywords 'words)
