...
(use-package evil
  ...
  (defun dzop/evil-org-insert-state-in-edit-buffer (fun &rest args)
    ...
    (let ((temp-evil-default-state evil-default-state)
      (temp-evil-emacs-state-modes evil-emacs-state-modes)
      (temp-evil-normal-state-modes evil-normal-state-modes)
      (temp-evil-motion-state-modes evil-motion-state-modes)
      (temp-evil-visual-state-modes evil-visual-state-modes)
      (temp-evil-operator-state-modes evil-operator-state-modes)
      (temp-evil-replace-state-modes evil-replace-state-modes))
      (setq
      ...
      (evil-refresh-cursor)
      (setq
       evil-default-state temp-evil-default-state
       evil-emacs-state-modes temp-evil-emacs-state-modes
       evil-normal-state-modes temp-evil-normal-state-modes
       evil-motion-state-modes temp-evil-motion-state-modes
       evil-visual-state-modes temp-evil-visual-state-modes
       evil-operator-state-modes temp-evil-operator-state-modes
       evil-replace-state-modes temp-evil-replace-state-modes)))
  :init
