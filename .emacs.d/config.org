...
(use-package evil
  ...
  (defun hcps/ensure-evil-and-quit ()
    (remove-hook 'pre-command-hook #'hcps/ensure-evil-and-quit)
    (require 'evil))
  :init
  ...
  :hook
  (pre-command-hook . hcps/ensure-evil-and-quit)
  :general
...
(use-package org
  ...
  (:states '(normal visual)
   ...
   "<S-up>" nil
   "<S-down>" nil)
  (:keymaps '(org-mode-map hcps/leader-map)
...
(use-package clang-format
  ...
  (defun cc-format-on-save-hook ()
    (when c-buffer-is-cc-mode
      (clang-format-buffer)))
  :general
  (:keymaps '(c-mode-base-map hcps/leader-map)
...
(use-package cperl-mode
  ...
  :general
  (:keymaps '(cperl-mode-map hcps/leader-map)
