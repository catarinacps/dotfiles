...
(use-package cc-mode
  ...
  :hook
  ((c-mode-common-hook . highligh-numbers-mode)
...
(use-package cuda-mode
  ...
  ((cuda-mode-hook . (lambda () (run-hooks 'prog-mode-hook)))
   (cuda-mode-hook . highlight-numbers-mode)
...
(use-package ess-r-mode
  ...
  ((ess-r-mode-hook . aggressive-indent-mode)
   (ess-r-mode-hook . highlight-numbers-mode)
   (ess-r-mode-hook . lsp))
  :preface
...
(use-package elpy
  :defer t
  :hook
  (python-mode-hook . highlight-numbers-mode)
  :init
...
(use-package julia-mode
  ...
  ((julia-mode-hook . julia-repl-mode)
   (julia-mode-hook . (lambda () (require 'lsp-julia) (lsp)))
